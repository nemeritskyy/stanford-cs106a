...
public interface NameSurferConstants {
     ...
     */
    public static final String NAMES_DATA_FILE = "src/com/shpp/p2p/cs/anemeritskyy/assignment7/assets/NamesData.txt";
     ...
     * Width for input
     */
    public static final int NAME_FIELD_SIZE = 20;

    /**
     * Default color array for visualisation
     */
    public static final Color[] NAMES_COLORS = {Color.BLUE, Color.RED, Color.MAGENTA, Color.BLACK};
}
