...
import com.shpp.p2p.cs.anemeritskyy.assignment6.sg.SteganographyConstants;
import com.shpp.p2p.cs.anemeritskyy.assignment6.sg.SteganographyDrawingCanvas;
import com.shpp.p2p.cs.anemeritskyy.assignment6.sg.SteganographyLogic;
import com.shpp.p2p.cs.anemeritskyy.assignment6.sg.SteganographyPictureCanvas;
...
public class Assignment6Part1 extends SimpleProgram implements SteganographyConstants {
    ...
    private static final File ASSETS_PATH = new File("assets/steganography");
    ...
    public class SteganographyFileFilter extends FileFilter {
        // $FF: synthetic field
        final Assignment6Part1 this$0;
        // $FF: synthetic field
        private final String[] val$extensions;
        // $FF: synthetic field
        private final String val$description;

        SteganographyFileFilter(Assignment6Part1 var1, String[] var2, String var3) {
            this.this$0 = var1;
        ...
        public boolean accept(File filename) {
            return filename.isDirectory() || Arrays.asList(this.val$extensions).contains(Assignment6Part1.access$0(this.this$0, filename));
        }
    ...
    // $FF: synthetic method
    static String access$0(Assignment6Part1 var0, File var1) {
